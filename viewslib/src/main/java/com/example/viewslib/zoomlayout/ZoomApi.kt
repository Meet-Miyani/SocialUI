...
interface ZoomApi {
    ...
    @Retention(AnnotationRetention.SOURCE)
    @IntDef(
        com.example.viewslib.zoomlayout.Alignment.BOTTOM,
        com.example.viewslib.zoomlayout.Alignment.CENTER_VERTICAL,
        com.example.viewslib.zoomlayout.Alignment.NONE_VERTICAL,
        com.example.viewslib.zoomlayout.Alignment.TOP,
        com.example.viewslib.zoomlayout.Alignment.LEFT,
        com.example.viewslib.zoomlayout.Alignment.CENTER_HORIZONTAL,
        com.example.viewslib.zoomlayout.Alignment.NONE_HORIZONTAL,
        com.example.viewslib.zoomlayout.Alignment.RIGHT,
        com.example.viewslib.zoomlayout.Alignment.CENTER,
        com.example.viewslib.zoomlayout.Alignment.NONE,
        flag = true
    )
    ...
    companion object {
         ...
         */
        const val ALIGNMENT_DEFAULT = com.example.viewslib.zoomlayout.Alignment.CENTER
    }
}